...
static void         _C_IDENTIFIER_BIND(PAIR_NAME, copy)(VECTOR_NAME* dest, const VECTOR_NAME* source);  \
static void         _C_IDENTIFIER_BIND(PAIR_NAME, move)(VECTOR_NAME* dest, VECTOR_NAME* source);        \
                                                                                                        \
static PAIR_NAME _C_IDENTIFIER_BIND(PAIR_NAME, create)(const TYPE_1* first, const TYPE_2* second)       \
{                                                                                                       \
    PAIR_NAME pair = {};                                                                                \
