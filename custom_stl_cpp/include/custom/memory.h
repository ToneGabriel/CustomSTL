...
struct _Get_Deleter_Pointer_Type { using type = Ty*; };

template<class Ty, class DeleterNoref>
struct _Get_Deleter_Pointer_Type<Ty, DeleterNoref, void_t<typename DeleterNoref::pointer>>
{
    // specialization for "pointer" alias
    using type = typename DeleterNoref::pointer;
};

template<class Deleter>
using _Enable_Default_Constructible_Deleter = enable_if_t<conjunction_v<
...
template<class Ty>
struct _Can_Scalar_Delete<Ty, void_t<decltype(delete custom::declval<Ty*>())>> : true_type {};

template<class Ty, class = void>
struct _Can_Array_Delete : false_type {};

template<class Ty>
struct _Can_Array_Delete<Ty, void_t<decltype(delete[] custom::declval<Ty*>())>> : true_type {};

template<class Func, class Arg, class = void>
struct _Can_Call_Function_Object : false_type {};

template<class Func, class Arg>
struct _Can_Call_Function_Object<Func, Arg, void_t<decltype(custom::declval<Func>()(custom::declval<Arg>()))>> : true_type {};

template<class Ty1, class Ty2>
struct _Is_Ptr_Convertible : is_convertible<Ty1*, Ty2*>::type {};

template<class Ty1, class Ty2>
struct _Is_Ptr_Convertible<Ty1, Ty2[]> : is_convertible<Ty1(*)[], Ty2(*)[]>::type {};

template<class Ty1, class Ty2, size_t Nx>
struct _Is_Ptr_Convertible<Ty1, Ty2[Nx]> : is_convertible<Ty1(*)[Nx], Ty2(*)[Nx]>::type {};
...
template<class Ty1, class Ty2>
struct _Is_Ptr_Compatible : is_convertible<Ty1*, Ty2*>::type {};

template<class Ty, size_t Nx>
struct _Is_Ptr_Compatible<Ty[Nx], Ty[]> : true_type {};

template<class Ty, size_t Nx>
struct _Is_Ptr_Compatible<Ty[Nx], const Ty[]> : true_type {};

template<class Ty, size_t Nx>
struct _Is_Ptr_Compatible<Ty[Nx], volatile Ty[]> : true_type {};

template<class Ty, size_t Nx>
struct _Is_Ptr_Compatible<Ty[Nx], const volatile Ty[]> : true_type {};

template<class Ty, class = void>
struct _Can_Enable_Shared : false_type {}; // detect unambiguous and accessible inheritance from enable_shared_from_this

template<class Ty>
struct _Can_Enable_Shared<Ty, void_t<typename Ty::_Esft_t>>
...
public:
    ...
    template<class Ty>
    bool owner_before(const _Shared_Weak_Base<Ty>& other) const noexcept
    {
...
public:
    ...
    using pointer       = typename detail::_Get_Deleter_Pointer_Type<Type, remove_reference_t<Deleter>>::type;
...
public:
    ...
    detail::_Enable_Default_Constructible_Deleter<Del> = true>
...
public:
    ...
    constexpr add_lvalue_reference_t<Type> operator*() const
    noexcept(noexcept(*custom::declval<pointer>()))
    {
       return *_ptr;
    }
...
public:
    ...
    using _Enable_Constructor_And_Reset =  enable_if_t<disjunction_v<
                                                        is_same<Ty, pointer>,
                                                        IsNullptr,
                                                        conjunction<
...
public:
    ...
    detail::_Enable_Default_Constructible_Deleter<Del> = true,
    _Enable_Constructor_And_Reset<Ty> = true>
...
public:
    ...
    template<class Ty, class Del,
    _Enable_Conversion<Ty, Del, is_assignable<Deleter&, Del>> = true>
    constexpr unique_ptr& operator=(unique_ptr<Ty, Del>&& other) noexcept
    {
        reset(other.release());
        _deleter = custom::forward<Del>(other._deleter);
...
public:
    ...
    template<class Ty, _Enable_Constructor_And_Reset<Ty, false_type> = true>    // false_type (allow nullptr)
...
constexpr unique_ptr<Ty> make_unique_for_overwrite()
{
    return unique_ptr<Ty>(new Ty());
}

template<class Ty, enable_if_t<is_unbounded_array_v<Ty>, bool> = true>
constexpr unique_ptr<Ty> make_unique_for_overwrite(const size_t _Size)
{
...
template<class Type>
class shared_ptr : public detail::_Shared_Weak_Base<Type>    // class for reference counted resource management
{
private:
    using _Base         = detail::_Shared_Weak_Base<Type>;
...
public:
    ...
    template<class Ty,
    enable_if_t<conjunction_v<
                    conditional_t<  is_array_v<Type>,
                                    detail::_Can_Array_Delete<Ty>,
                                    detail::_Can_Scalar_Delete<Ty>>,
                    detail::_Is_Ptr_Convertible<Ty, Type>>,
    bool> = true>
    ...
    enable_if_t<conjunction_v<
                    ...
                    detail::_Can_Call_Function_Object<Del&, Ty*&>,
                    detail::_Is_Ptr_Convertible<Ty, Type>>,
    bool> = true>
    ...
    enable_if_t<conjunction_v<
                    is_move_constructible<Del>, 
                    detail::_Can_Call_Function_Object<Del&, std::nullptr_t&>>, 
    bool> = true>
    ...
    template<class Ty, enable_if_t<detail::_Is_Ptr_Compatible<Ty, Type>::value, bool> = true>
    ...
    template<class Ty, class Del,
    enable_if_t<conjunction_v<
                    detail::_Is_Ptr_Compatible<Ty, Type>,
    ...
    shared_ptr(unique_ptr<Ty, Del>&& unique)
    {
        ...
        if (ptr)
        {
            ...
            const auto refCount = new detail::_Ref_Count_Deleter<UnqPointer_t, UnqDeleter_t>(ptr, custom::forward<Del>(unique.get_deleter()));
...
private:
    ...
    {
        detail::_Temporary_Owner_Del<TypePtr, Deleter> temp(ptr, del);
        _set_ptr_rep_and_enable_shared(temp._Ptr, new detail::_Ref_Count_Deleter<TypePtr, Deleter>(temp._Ptr, custom::move(del)));
    ...
    {
        using _RefCountDelAl            = detail::_Ref_Count_Deleter_Alloc<TypePtr, Deleter, Alloc>;
    ...
    template<class Ty>
    void _set_ptr_rep_and_enable_shared(Ty* const ptr, detail::_Ref_Count_Base* const refCount) noexcept    // take ownership of ptr
    {
        this->_ptr = ptr;
        this->_rep = refCount;
        ...
        if constexpr (conjunction_v<
                            ...
                            detail::_Can_Enable_Shared<Ty>>)
            if (ptr && ptr->_wptr.expired()) 
                ptr->_wptr = shared_ptr<remove_cv_t<Ty>>(*this, const_cast<remove_cv_t<Ty>*>(ptr));
    }

    void _set_ptr_rep_and_enable_shared(std::nullptr_t, detail::_Ref_Count_Base* const refCount) noexcept   // take ownership of nullptr
    {
        this->_ptr = nullptr;
        this->_rep = refCount;
    }
...
template<class Type>
class weak_ptr : public detail::_Shared_Weak_Base<Type>    // class for pointer to reference counted resource
{
public:
    // Constructors
